...
class PipelineEvaluator:
    ...
    def run_evaluation(self, expected_fields, expected_methods):
        ...
        model_json, r_lat, g_lat = self.chat.generate_domain_model(self.chat.target_folder)
    ...
    def print_report(self):
        print("\n" + "="*50)
        print("📊 KPI REPORT: SALES INVOICE PIPELINE")
        print("="*50)
...
if __name__ == "__main__":
    ...
    TEST_FOLDER = r"C:/Users/Aagam/OneDrive/Desktop/erpnext/erpnext/accounts/doctype/sales_invoice"
    chat = ModernizationChat(TEST_FOLDER)
